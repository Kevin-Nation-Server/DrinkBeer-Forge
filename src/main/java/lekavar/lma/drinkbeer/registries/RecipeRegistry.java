...
public class RecipeRegistry {
    ...
    public static final RegistryObject<RecipeType<BrewingRecipe>> RECIPE_TYPE_BREWING = RECIPE_TYPES.register("brewing", () -> RecipeType.simple(new ResourceLocation("drinkbeer","brewing")));
